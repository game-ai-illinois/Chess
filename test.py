...
self_play_n_games = 20#400 #on the paper it's 25k and 16k simulation b4 each move, though the paper is on go where average legal moves are much higher
for iteration in range(100): #prev n_iterations
    #self play
