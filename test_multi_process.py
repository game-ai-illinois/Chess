...
if __name__ == '__main__':
    ...
    input_size = 12
    n_iterations = 400
    self_play_n_games = 385# was 400 #on the paper it's 25k and 16k simulation b4 each move, though the paper is on go where average legal moves are much higher
    manager = Manager()
    archive = manager.list()
    for iteration in range(5): # prev n_iterations
        #self play
        ...
        #     total_n_draws = None
        #     p1 = mp.Process(target=test_multiprocess, args=(archive, self_play_n_games//7, black, black, device, self_play, total_n_black_wins, total_n_draws))
        #     p2 = mp.Process(target=test_multiprocess, args=(archive, self_play_n_games//7, black, black, device, self_play, total_n_black_wins, total_n_draws))
        #     p3 = mp.Process(target=test_multiprocess, args=(archive, self_play_n_games//7, black, black, device, self_play, total_n_black_wins, total_n_draws))
        #     p4 = mp.Process(target=test_multiprocess, args=(archive, self_play_n_games//7, black, black, device, self_play, total_n_black_wins, total_n_draws))
        #     p5 = mp.Process(target=test_multiprocess, args=(archive, self_play_n_games//7, black, black, device, self_play, total_n_black_wins, total_n_draws))
        #     p6 = mp.Process(target=test_multiprocess, args=(archive, self_play_n_games//7, black, black, device, self_play, total_n_black_wins, total_n_draws))
        #     p7 = mp.Process(target=test_multiprocess, args=(archive, self_play_n_games//7, black, black, device, self_play, total_n_black_wins, total_n_draws))
        #     # p8 = mp.Process(target=test_multiprocess, args=(archive, self_play_n_games//5, black, black, device, self_play, total_n_black_wins, total_n_draws))
        #     # p9 = mp.Process(target=test_multiprocess, args=(archive, self_play_n_games//5, black, black, device, self_play, total_n_black_wins, total_n_draws))
        #     p1.start()
        #     p2.start()
        #     p3.start()
        #     p4.start()
